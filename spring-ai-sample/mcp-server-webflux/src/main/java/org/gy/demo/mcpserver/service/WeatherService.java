...
public class WeatherService {
    ...
    public String getWeatherForecastByLocation(double latitude, double longitude) {
        ...
        var points = restClient.get().uri("/points/{latitude},{longitude}", latitude, longitude).retrieve().body(Points.class);
    ...
    public String getAlerts(String state) {
        ...
        return alert.features().stream().map(f -> String.format("""
                Event: %s
                Area: %s
                Severity: %s
                Description: %s
                Instructions: %s
                """, f.properties().event(), f.properties.areaDesc(), f.properties.severity(), f.properties.description(), f.properties.instruction())).collect(Collectors.joining("\n"));
    }
